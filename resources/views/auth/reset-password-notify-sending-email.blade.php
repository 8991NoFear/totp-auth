     ...
     <div class="row m-0">
         <div class="col-md-6 offset-md-3">
             <div class="d-flex justify-content-center align-items-center flex-column vh-100 text-center">
                ...
                <p>For improved security, you must reset your password by <span class="fw-bold">{{ $expired_at }}</span> so that you can continue using our website. Please check your email and follow the link to reset your password</p>  
