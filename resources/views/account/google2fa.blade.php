    ...
    <div class="row">
        <div class="col-sm-6 offset-sm-3 mt-3">
            <div class="d-flex flex-row justify-content-between align-items-center border rounded-3 p-3">
                ...
                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal" id="toggleBtn" data="off">TURN OFF</button>
                @else
        ...
        <form action="{{ route('account.security.setup-g2fa') }}" method="post">
            ...
            <div class="col-sm-6 offset-sm-3">
                ...
                <p class="ms-3 me-3 text-start">Notice that if you submit totp code succeed, we will create
                    ...
                    > Security > Backup codes to see them.
                </p>
                <input type="number" id="totp-code" class="my-form-control text-center w-75  @error('totp_code') invalid @enderror" id="floatingInput" placeholder="6 digits OTP code" name="totp_code">
                @error('totp_code')
                <div style="color: red">
                    *{{ $message }}
                </div>
